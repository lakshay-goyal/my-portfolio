...
const SocialIcon = ({ href, icon: Icon, label }) => (
  <a
    ...
    aria-label={label}
  >
    <div className="p-4 bg-zinc-800/50 rounded-xl hover:bg-zinc-700/50 group">
      {Icon}
    </div>
    <span
      className="absolute -top-14 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 
        ...
        px-4 py-2 rounded-md text-sm font-semibold tracking-wide min-w-max
...
const HeroSection = () => {
  ...
  return (
    <section
      className="relative min-h-screen bg-zinc-900 flex items-center justify-center overflow-hidden"
      id="Home"
    >
      <div className="absolute inset-0 opacity-15">
        <div className="absolute top-0 left-0 w-full h-full bg-[linear-gradient(45deg,rgba(39,39,42,0.07)_25%,transparent_25%,transparent_50%,rgba(39,39,42,0.07)_50%,rgba(39,39,42,0.07)_75%,transparent_75%,transparent)] bg-[length:64px_64px]"></div>
      </div>

      <div className="absolute top-0 right-0 w-96 h-96 bg-teal-500/10 rounded-full blur-3xl animate-blob"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-rose-500/10 rounded-full blur-3xl animate-blob animation-delay-4000"></div>
      <div className="absolute top-1/2 left-1/4 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl animate-blob animation-delay-2000"></div>
      ...
      <div className="container mx-auto px-6 z-10 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div
            ...
            data-aos="fade-up"
          >
            <h1 className="text-6xl md:text-8xl font-black text-white mb-8 tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-teal-400 via-blue-500 to-rose-500">
              Lakshay Goyal
            </h1>
          </div>

          <div className="text-3xl md:text-5xl text-gray-200 mb-10 flex justify-center items-center">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-zinc-900 via-zinc-900/80 to-transparent"></div>

      <div className="absolute inset-0 z-0">
        <div className="absolute h-2 w-2 bg-teal-500/20 rounded-full top-1/4 left-1/4 animate-pulse"></div>
        <div className="absolute h-2 w-2 bg-rose-500/20 rounded-full top-3/4 right-1/4 animate-pulse animation-delay-2000"></div>
        <div className="absolute h-2 w-2 bg-blue-500/20 rounded-full top-1/2 left-3/4 animate-pulse animation-delay-4000"></div>
      </div>
    </section>
  );
};
